...
public class Locators {
	...
	public static void locatorsAttribute() {
		driver.findElement(By.id("loginfmt")).sendKeys("divya.user@lab.ontryvium.com");
		driver.findElement(By.id("idSIButton9")).click();
		driver.findElement(By.name("passwd")).sendKeys("Vuv48886");
		driver.findElement(By.id("idSIButton9")).click();
